...
# Apply Xcode selection defaults for dotnet10.
case "$xcode_behavior" in
  default)
    export DOTNETENV_REQUIRED_XCODE_VERSION_DOTNET10="$xcode_default_version"
    export DOTNETENV_FORCE_XCODE_AUTO=1
    ;;
  set)
    export DOTNETENV_REQUIRED_XCODE_VERSION_DOTNET10="${xcode_set_version:-$xcode_default_version}"
    export DOTNETENV_FORCE_XCODE_AUTO=1
    ;;
  derive)
